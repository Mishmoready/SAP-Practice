sap.ui.define([
	...
	return Controller.extend("sap.ui5.shelfReplenishmentReport.controller.CardsLayout", {
		...
		onInit: function () {
			...
			cardManifests.loadData(sap.ui.require.toUrl("sap/ui5/shelfReplenishmentReport/model/cardManifests.json"));
